...
<div class="main-panel">
    <div class="content-wrapper">
        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <form name="form" action="<?= base_url('Admin/actedit_jtayang') ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                        <div class="row">
                        </div>
                        <div class="row">
                            <?php
                            ...
                            ?>
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="time" name="jam_tayang[]" class="form-control" placeholder="" required value="<?= $r->jam_tayang ?>">
                                </div>
                            <?php } ?>
                        </div>
